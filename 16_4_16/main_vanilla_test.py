...
parser.add_argument('--alpha_lr', type=float, default=0.0002, metavar='G',
...
for i_episode in range (args.max_episode): 
    ...
    # ckpt_path = "checkpoints/sac_checkpoint_QuaDriGa_SAC_KNN_16_4_16_vanilla_1_1_mobile_"
    ...
    while not done:
        ...
        mod_ue_time = time.time()
        print("mod ue time is:", mod_ue_time-pred_time)
        ...
        print("data processing time is:", data_process_time-mod_ue_time)
        ...
        state = next_state
        end_time = time.time()
        print("memory push time is:", end_time - data_process_time)
    ...
    #     agent.save_checkpoint('QuaDriGa_SAC_KNN_16_4_16_vanilla_1_1_mobile')
