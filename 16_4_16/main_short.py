...
for i_episode in range (args.max_episode): 
    ...
    ckpt_path = "checkpoints/sac_checkpoint_QuaDriGa_SAC_KNN_16_4_16_mobile_"
    ...
    while not done:
        ...
        # else:
        #     action, final_action = agent.select_act0.016103744506835938ion(state)  # Sample action from policy
        # print('final action is: ', final_action)
