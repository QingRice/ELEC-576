...
# reward_record = np.zeros((1,))
history_record = np.zeros((400,num_ue))
# max_history_record = np.zeros((1,num_ue))
...
for i_episode in range (0,1): 
    ...
    #     agent.save_checkpoint('QuaDriGa_SAC_KNN_641664_rdm')
...
with h5py.File("./64_16_64_vanilla_mob_test_2.hdf5", "w") as data_file:
