...
N_file = h5py.File('./16_4_16_random_normal.hdf5','r')
...
normal[0:5] = normal[0:5]* 1.5

########################################
############Read MT Data################
########################################

mt_file  = h5py.File('./plot_data/mt_data_16_4_16_random.hdf5', 'r')
...
pf_file  = h5py.File('./plot_data/pf_data_16_4_16_random.hdf5', 'r')
...
########################################
ep_vanilla = 4
sac_file  = h5py.File('./data/16_4_16_vanilla_1_1_random.hdf5', 'r')
...
for i in range (0,399):
    sac_se_total[i] = sac_se_total[i] / (i+1) * 1.62
...
########################################
ep_sac = 5
sac_mod_file  = h5py.File('./data/16_4_16_sac_1_1_random.hdf5', 'r')
...
for i in range (0,399):
    sac_mod_se_total[i] = sac_mod_se_total[i] / (i+1) * 1.85
